 ...
 */
export async function createBranch({ owner, repo, newBranch, sourceBranch = "main", }) {
    if (!GITHUB_TOKEN) {
    ...
    try {
        ...
        const sourceRef = await axios.get(`https://api.github.com/repos/${owner}/${repo}/git/ref/heads/${sourceBranch}`, { headers });

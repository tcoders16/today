 ...
 */
export function showImage(width: number = 60, height: number = 30, grayscale = false) {
...
function getIntroMessage(): string {
  ...
  const welcome = `${chalk.magenta.bold("Welcome to Om's GitHub AiAgent")}\n${chalk.gray(
    "A CLI tool that lets you manage GitHub using plain English commands powered by OpenAI."
  )}`;
